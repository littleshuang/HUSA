...
public abstract class BaseConceptParser implements HownetMeta, WordSimilarity {
	...
	private static void firstLoad() throws IOException {
		...
		InputStream input = new FileInputStream("G://HUSA/libs/data/concept.xml");
		load(input);
	}
