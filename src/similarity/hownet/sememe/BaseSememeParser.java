package similarity.hownet.sememe;

import com.google.common.collect.HashMultimap;
import com.google.common.collect.Multimap;
import similarity.hownet.HownetMeta;
import similarity.hownet.Similaritable;
...
public abstract class BaseSememeParser implements HownetMeta, Similaritable {
	...
	public BaseSememeParser() throws IOException {
		...
		// InputStream input = this.getClass().getClassLoader().getResourceAsStream("G://HUSA/libs/data/sememe.xml.gz");
		String sememe = "G://HUSA/libs/data/sememe.xml";
		InputStream input = new FileInputStream(sememe);
		load(input);
	}
