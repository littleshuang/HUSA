...
public class Para {
	...
	private List<Segment> sentenceList = null;
	private float score;
	...
	private void setBeforeNext() {
		for (int i = 0; i < sentenceList.size(); i++) {
			...
			if (nextIndex < sentenceList.size()) {
				Segment curStr = sentenceList.get(i);
				Segment nextStr = sentenceList.get(nextIndex);
	...
	public List<Segment> getSentenceList() {
		return sentenceList;
	}

	public void setSentenceList(List<Segment> sentenceList) {
		this.sentenceList = sentenceList;
	}
